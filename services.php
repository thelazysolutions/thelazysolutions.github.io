        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-center">
                ...
                <div class="text-center">
                	<h1 style="font-weight:700;padding-bottom: 34px;border-bottom: 4px solid #286ce8;">Our Services</h1>
                </div>
            </div>
        </div>
        <div class="row align-items-center" style="padding-top:30px;">
            ...
            <div class="col-md-6 col-sm-12">
                <div class="heading_s2"> 
                  <h2 style="font-weight:600;">HISTORY</h2>
                </div>
...
<section  id="services" style="background:#eefdfd;">
    ...
    <div class="row justify-content-center">
        	...
        	<div class="col-lg-8 col-md-9 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.1s" style="animation-delay: 0.1s; opacity: 1;">
            	<div class="text-center">
                	<h3 style="font-weight:700;padding-bottom:50px;"> ELIGIBILITY FOR PORTUGUESE NATIONALITY & PORTUGUESE PASSPORT</h3>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
...
<section>
    ...
    <div class="row justify-content-center">
        	<div class="col-lg-8 col-md-9 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.1s" style="animation-delay: 0.1s; opacity: 1;">
            	<div class="text-center">
                	<h3 style="font-weight:700;padding-bottom:20px;"> OUR SERVICES FOR OBTAINING PORTUGUESE NATIONALITY & PORTUGUESE PASSPORT</h3>
        ...
        <section  id="services" style="background:#1a3652;">
            <div class="container">
            <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-9 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.1s" style="animation-delay: 0.1s; opacity: 1;">
                        <div class="text-center">
                            <h3 style="font-weight:700;padding-bottom:50px;color:#fff;"> FOUR STAGES TO ACQUIRE PORTUGUESE PASSPORT/NATIONALITY:</h3>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-6 col-sm-6 mb-lg-5 mb-3 text-center">
                        <div class="icon_box icon_box_style_9"  style="border: 2px solid #ccc;min-height:256px;">
                            <div class="box_icon mb-3">	
                               <h2 style="color:#fff;">Divorce</h2>
                            </div>
                            <div class="icon_box_content">
                                <p style="text-transform: uppercase;color: #cccbcb;">
                                    We assist the annulment process of divorce cases by mediating for our clients in the established Civil registry.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 mb-lg-5 mb-3 text-center">
                        <div class="icon_box icon_box_style_9" style="border: 2px solid #ccc;">
                            <div class="box_icon mb-3">	
                                <h2 style="color:#fff;">Correction of indian passport
                                </h2>
                            </div>
                            <div class="icon_box_content">
                                <p style="text-transform: uppercase;color: #cccbcb;">Your Passport is used as a recognized document 
                                    of identification, any error in it is counterproductive to the process. Our services help in correcting
                                     any inconsistencies in your Indian passport.
                ...
                <div class="row justify-content-center">
                    <div class="col-md-6 col-sm-6 mb-lg-5 mb-3 text-center">
                        <div class="icon_box icon_box_style_9"  style="border: 2px solid #ccc;">
                            <div class="box_icon mb-3">	
                               <h2 style="color:#fff;">Correction of Birth/Marriage certificate and teor(Content).
                            </h2>
                            </div>
                            <div class="icon_box_content">
                                <p style="text-transform: uppercase;color: #cccbcb;">
                                    Birth and marriage certificates may have errors, we pay specific attention to ensure correct details and content in all your paperwork. All births registered before 1970 have shifted to the Directorate of Archives & Archaeology, Panjim - Goa 
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-sm-6 mb-lg-5 mb-3 text-center">
                        <div class="icon_box icon_box_style_9" style="border: 2px solid #ccc;min-height:313px;">
                            <div class="box_icon mb-3">	
                                <h2 style="color:#fff;">Residence Certificate
                                </h2>
                            </div>
                            <div class="icon_box_content" style="padding-top:44px;">
                                <p style="text-transform: uppercase;color: #cccbcb;">Avoid the stressful process of dealing with 
                                    the respective mamlatdar, municipality, panchayat. Let us source out all your necessary documents.
                                    The Residence Certificate is required so as to decide the jurisdiction of the Portuguese Consulate.
            ...
            <div class="row justify-content-center" style="padding-bottom:20px;">
                ...
                <div class="row justify-content-center">
                    <div class="field_form">
                        ...
                        <div class="row align-items-center" style="background: #1a3652;">
                            <div class="col-md-4 col-sm-12 mb-4 mb-lg-0 animation animated fadeInLeft" data-animation="fadeInLeft" data-animation-delay="0.2s" style="animation-delay: 0.2s; opacity: 1;">
                        ...
                        <div class="row" style="padding-top:30px;">
                            <div class="col-lg-4 col-md-6 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.2s" style="animation-delay: 0.2s; opacity: 1;">
                                <div class="form-group col-lg-4">
                                 ...
                                 <div class="form-group col-lg-4">
                                    <label> PATERNALGRANDMOTHER:</label>
                                 </div>
                                 <div class="form-group col-lg-4">
                                    <label>MATERNALGRANDFATHER:</label>
                                 </div>
                                 <div class="form-group col-lg-4">
                                    <label>MATERNALGRANDMOTHER:</label>
                                 </div>
                                 <div class="form-group col-lg-4">
                                    <label> PATERNALGRANDFATHER :</label>
                                 </div>
                            ...
                            <div class="col-lg-8 col-md-6">
                                ...
                                <div class="field_form">
                                        <div class="row">
                                            <div class="form-group col-lg-3">
                                                <input required="required" class="form-control" name="name" type="text" style="background:none;">
                                             </div>
