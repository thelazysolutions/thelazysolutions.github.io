        ...
        <div class="row justify-content-center">
            <div class="col-md-10 col-sm-12 text-center">
                ...
                <div class="text-center">
                	<h1 style="font-weight:700;padding-bottom: 34px;border-bottom: 4px solid #286ce8;text-transform: uppercase;">Portuguese Citizenship</h1>
                </div>
            </div>
        </div>
        ...
        <section  id="services" style="background:#1a3652;">
            ...
            <div class="row justify-content-center">
                    <div class="col-lg-10 col-md-9 animation animated fadeInUp" data-animation="fadeInUp" data-animation-delay="0.1s" style="animation-delay: 0.1s; opacity: 1;">
                        <div class="text-center">
                            <h3 class ="desktop_display" style="font-weight:700;padding-bottom:50px;color:#fff;"> FOUR STAGES TO ACQUIRE PORTUGUESE PASSPORT/NATIONALITY:</h3>
                            <h5 class ="mob_display" style="font-weight:700;color:#fff;"> FOUR STAGES TO ACQUIRE PORTUGUESE PASSPORT/NATIONALITY:</h5>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-4 col-sm-6 mb-lg-5 mb-3 text-center">
                        <div class="icon_box icon_box_style_9" style="border: 2px solid #ccc;">
                            <div class="box_icon mb-3">	
                                <h1 style="color:#fff;">STAGE VI</h1>
                            </div>
                            <div class="icon_box_content">
                                <p style="text-transform: uppercase;color: #cccbcb;">If you are a descendant of
                                    a deceased parent/grandparent
