	...
	<div class="container">
        <div class="row justify-content-center">
        	...
        	<div class="col-lg-12 col-md-12 col-sm-12 text-center">
            	<ul class="portfolio_gallery portfolio_style4 carousel_slide2 owl-carousel owl-dots owl-theme " data-margin="15" data-dots="false" data-autoplay="true" data-nav="true" data-loop="true" data-autoplay-timeout="2500" style="position: relative;top:10%;">
                    <!-- START PORTFOLIO ITEM -->
                    <li class="portfolio-item" style="padding:30px;">
